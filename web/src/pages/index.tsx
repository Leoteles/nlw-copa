...
import appPreviewImg from '../assets/app-cellphone.png'
...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        <Image src={logoImg} alt="Logo bolao copa"/>
        ...
        <p className='mt-4 text-sm text-gray-300 leading-relaxed'>
          Após criar o seu bolão, você receberá um código único que poderá para convidar outras pessoas</p>
